...
import net.mwforrest7.vineyard.block.custom.GrapePressBlock;
...
public class ModBlocks {
    ...
    public static final Block GRAPE_PRESS = registerBlock("grape_press", new GrapePressBlock(FabricBlockSettings.of(Material.METAL).nonOpaque()));
