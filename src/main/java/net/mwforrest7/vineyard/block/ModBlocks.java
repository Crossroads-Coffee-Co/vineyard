...
public class ModBlocks {
    ...
    public static final Block ATTACHED_GREEN_GRAPEVINE_TRUNK = registerBlockWithoutBlockItem(BlockNames.ATTACHED_GREEN_GRAPEVINE_TRUNK_KEY, new AttachedVineTrunkBlock(VineType.GREEN_GRAPE.toString(), FabricBlockSettings.of(Material.PLANT).strength(1.0f).nonOpaque().sounds(BlockSoundGroup.WOOD)));
    public static final Block GREEN_GRAPEVINE_TRUNK = registerBlockWithoutBlockItem(BlockNames.GREEN_GRAPEVINE_TRUNK_KEY, new VineTrunkBlock(VineType.GREEN_GRAPE.toString(), FabricBlockSettings.of(Material.PLANT).strength(1.0f).nonOpaque().sounds(BlockSoundGroup.WOOD)));
    public static final Block GREEN_GRAPE_CANOPY = registerBlockWithoutBlockItem(BlockNames.GREEN_GRAPE_CANOPY_KEY, new GreenGrapeBlock(FabricBlockSettings.of(Material.PLANT).strength(1.0f).nonOpaque().sounds(BlockSoundGroup.SWEET_BERRY_BUSH)));
    public static final Block ATTACHED_GREEN_GRAPE_HEAD = registerBlockWithoutBlockItem(BlockNames.ATTACHED_GREEN_GRAPE_HEAD_KEY, new AttachedVineHeadBlock((VineCanopyBlock)GREEN_GRAPE_CANOPY, FabricBlockSettings.of(Material.PLANT).strength(1.0f).nonOpaque().sounds(BlockSoundGroup.SWEET_BERRY_BUSH)));
    public static final Block GREEN_GRAPE_HEAD = registerBlockWithoutBlockItem(BlockNames.GREEN_GRAPE_HEAD_KEY, new VineHeadBlock((VineCanopyBlock)GREEN_GRAPE_CANOPY, (AttachedVineTrunkBlock) ATTACHED_GREEN_GRAPEVINE_TRUNK, FabricBlockSettings.of(Material.PLANT).strength(1.0f).nonOpaque().sounds(BlockSoundGroup.SWEET_BERRY_BUSH)));
    ...
    public static final Block AGED_FRUITY_RED_WINE_CASK = registerBlock(BlockNames.AGED_FRUITY_RED_WINE_CASK_KEY, new AgedWineBlock(FabricBlockSettings.of(Material.WOOD).nonOpaque().strength(2.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block AGED_STRONG_WHITE_WINE_CASK = registerBlock(BlockNames.AGED_STRONG_WHITE_WINE_CASK_KEY, new AgedWineBlock(FabricBlockSettings.of(Material.WOOD).nonOpaque().strength(2.5f).sounds(BlockSoundGroup.WOOD)));
